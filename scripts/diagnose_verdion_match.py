"""Einmal-Diagnose: prüft, ob das domänen-gestützte KI-Matching den Verdion-Fall findet.

Baut den Deal aus dem #newsletter-Digest ("Brabus mietet im Verdion PremierPark
Berlin") und durchläuft die VOLLE Pipeline wie im Produktivlauf:
propose_search_terms -> gather_candidates -> select_match, gegen das echte
Propstack + Claude (mit DOMAIN_CONTEXT). Reiner Lese-Lauf, keine Writes.
"""
...
def main() -> None:
    ...
    print("\nKI-Suchbegriffe (Query-Expansion):", terms)
