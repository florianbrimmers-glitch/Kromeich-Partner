...
| M11 Sound (CC0), M12 Wochenereignisse | offen |
...
| M8 Teil 2 (Wiederbelebung, Segen/Gebet, Schild, Konterschlag, Karten-Zauber) | offen |
| M7 Teil 2 (Totenerweckung, Taktik-Aufstellung, Wegfindung) | offen |
...
**Test-Falle: `_next_round()` laesst die KI ziehen.** Wer im Test mehrere
...
aufsetzen, nicht durch Runden laufen.
